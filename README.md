...
<ol>
  ...
  <li> Создал на <b>HTML</b> (с <b>CSS</b>) шаблоны страниц авторизации, регистрации и формы отправки запросов, получения ответов. </li>
  <li> Создал приложение <b>users</b> для работы с блоком функций <b>авторизации</b> и <b>регистрации</b> пользователей.  <br />
          ...
          - Добавил в HTML-документы авторизации и регистрации <b>шаблонные теги</b> Django для вывода полей авторизации и регистрации.
  <li> Создал приложение<b> forms </b>для работы с блоком функций <b>отправки запроса</b> в <b>ChatGPT</b> и <b>получения ответов</b>. </li>
          ...
          - В <b>forms/forms</b> создал класс для отправки <b>запроса</b>;
          - Во <b>forms/views</b> создал следующие функции: <br />
              ...
              Также, помимо описанного, ф-ции в <b>views</b> решают такие задачи, как: <br />
                      ...
                      > сохранение отдельных данных запроса в таблицу в <b>БД MySQL</b> на веб-сервере;<br />
     ...
     <li> Настроил сохранение данных запроса и ответа в БД MySQL веб-сервера на осн. phpMyAdmin (вместо исп. стандартной БД SQLite3).</b>. </li>
